...
// The transaction must also show up on the transaction history - once the user has connected to the server again via internet.

// When offline entries are stored, they should be added to a type of tracker.
